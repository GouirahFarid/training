        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    <!--begin::Add product-->
                    <button @click="showCreateFormationModel" class="btn btn-primary">Add Product</button>
                    <!--end::Add product-->
                </div>
                <!--end::Card toolbar-->
            </div>
            ...
            <div class="card-body pt-0">
                ...
                <table class="table  table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <td>
                            <button @click="showUpdateFormationModel(formation.id)" class="btn btn-primary">Edit</button>
                            <button @click="deleteFormation(formation.id)" class="btn btn-danger">Delete</button>
                        </td>
                    </tr>
                    </tbody>
                </table>
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-10 pt-0 pb-15">
                        ...
                        <div class="mh-475px scroll-y me-n7 pe-7">
                            <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    <button @click="createFormation" class="btn btn-success float-end"> Create</button>
                                    <button @click="UpdateFormation" class="btn btn-success float-end"> Update</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods:{
        ...
        createFormation(){
            axios.post('http://localhost:8000/api/formations',{titre:this.formation.titre,heures:this.formation.heures})
                .then(()=>{
                    let formationModal = new bootstrap.Modal(document.getElementById('kt_modal_create_formation'));
                    formationModal.hide();
        ...
        UpdateFormation(){
            axios.put(`http://localhost:8000/api/formations/${this.formation.id}`,{titre:this.formation.titre,heures:this.formation.heures})
                .then(()=>{
                    let formationModal = new bootstrap.Modal(document.getElementById('kt_modal_create_formation'));
                    formationModal.hide();
        ...
        deleteFormation(id){
            axios.delete(`http://localhost:8000/api/formations/${id}`,)
                .then(()=>{
